export default function Page() {
	return (
		<div>The Saudi Energy Ministry said the kingdom&aposs East-West pipeline was shut down as a precautionary measure after multiple attacks.
The Saudis have relied on the East-West pipeline to shift crude oil exports away from Persian Gulf as the U.S. and Iran battle for control over the Strait of Hormuz.
In this article
@LCO27G-2.22 (-2.35%)
@LCO26X-2.92 (-2.71%)
...
Saudi Arabia shut down its crucial East-West crude oil pipeline as a precautionary measure after multiple attacks, the kingdom&aposs Energy Ministry said Friday in a statement.
...
Emergency teams were deployed to secure the pipeline and assess its safety after Thursday&aposs attacks, the Saudi Energy Ministry said. “Any further developments will be announced in due course,” the ministry said.
