...
export default function Settings() {
  ...
  return (
    <div 
      className={
        "rounded-3xl fixed transition-all duration-500 ease-satis select-none border-stone-950 " + 
        ( open 
          ? "h-3/4 w-3/4 p-10 bottom-1/2 right-1/2 translate-x-1/2 translate-y-1/2 bg-slate-800 border-4" 
          : "h-12 w-12 bottom-4 right-4 cursor-pointer"
        )
      }
    ...
    >
      ...
      <svg className={"transition-all duration-500 absolute abs-center h-full w-full pointer-events-none " + (open ? "opacity-0" : "opacity-100")} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0,0,256,256">
